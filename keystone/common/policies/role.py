...
role_policies = [
    policy.DocumentedRuleDefault(
        ...
        operations=[
            {'path': '/v3/roles/{role_id}', 'method': 'GET'},
            {'path': '/v3/roles/{role_id}', 'method': 'HEAD'},
        ],
    ...
    policy.DocumentedRuleDefault(
        ...
        operations=[
            {'path': '/v3/roles', 'method': 'GET'},
            {'path': '/v3/roles', 'method': 'HEAD'},
        ],
    ...
    policy.DocumentedRuleDefault(
        ...
        operations=[{'path': '/v3/roles', 'method': 'POST'}],
    ...
    policy.DocumentedRuleDefault(
        ...
        operations=[{'path': '/v3/roles/{role_id}', 'method': 'PATCH'}],
    ...
    policy.DocumentedRuleDefault(
        ...
        operations=[{'path': '/v3/roles/{role_id}', 'method': 'DELETE'}],
    ...
    policy.DocumentedRuleDefault(
        ...
        scope_types=['system', 'project'],
        operations=[
            {'path': '/v3/roles?domain_id={domain_id}', 'method': 'GET'},
            {'path': '/v3/roles?domain_id={domain_id}', 'method': 'HEAD'},
        ],
